...
<template>
  <header class="relative mx-auto flex w-full max-w-screen-xl auto-cols-fr items-center justify-between p-5">
    <button
    ...
    <p class="absolute left-1/2 mx-auto hidden -translate-x-1/2 text-3xl text-alba-orange xl:block">
      Alba Omsorg
    </p>
    <div class="md:hidden">
      <button
